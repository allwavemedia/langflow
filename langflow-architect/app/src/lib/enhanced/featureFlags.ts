...
export interface QuestioningFeatureFlagsConfig {
...
const DEFAULT_QUESTIONING_FLAGS: QuestioningFeatureFlagsConfig = {
...
export class QuestioningFeatureFlags {
  ...
  updateFeatureFlag(flag: keyof QuestioningFeatureFlagsConfig, value: boolean): void {
    if (this.isDebugModeEnabled()) {
      (this.config.featureFlags as unknown as Record<string, boolean | number>)[flag] = value;
    }
  }
