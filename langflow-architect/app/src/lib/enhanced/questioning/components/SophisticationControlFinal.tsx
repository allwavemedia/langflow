...
const SophisticationControl: React.FC<SophisticationControlProps> = ({
  ...
  return (
    <div className={uiUtils.utils.cn('space-y-3', config.container, className)}>
      ...
      {/* Level buttons arranged horizontally */}
        ...
        {activeLevels.map((level) => {
          ...
          return (
            <button
              ...
              className={uiUtils.utils.cn(
                config.thumb,
                'rounded-full border-2 border-white shadow-sm transition-all duration-200 flex items-center justify-center font-medium',
                colors.bg,
                colors.text,
